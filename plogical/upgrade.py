...
class Upgrade:
    ...
    def download_install_phpmyadmin():
        try:
            ...
            command = 'wget -O /usr/local/CyberCP/public/phpmyadmin.zip https://github.com/josephgodwinkimani/cyberpanel-2.3.2/raw/v2.3.2/phpmyadmin.zip'
            Upgrade.executioner(command, 0)
    ...
    'rootdb': {
        ...
        'PORT': '%s',
            ...
            if currentBranch.find('On branch %s' % (branch)) > -1 and currentBranch.find(
                ...
                command = 'git clone https://github.com/josephgodwinkimani/cyberpanel-2.3.2'
                if not Upgrade.executioner(command, command, 1):
                    return 0, 'Failed to execute %s' % (command)
...
"""
    ...
    def runSomeImportantBash():
        ...
        # Remove invalid crons from /etc/crontab Reference: https://github.com/josephgodwinkimani/cyberpanel-2.3.2/issues/216
...
"""
    ...
    def upgrade(branch):
        ...
        if not os.path.exists('/usr/local/lsws/bin/openlitespeed'):
            ...
            command = 'wget https://raw.githubusercontent.com/josephgodwinkimani/cyberpanel-2.3.2/v2.3.2/install/litespeed/httpd_config.xml'
            Upgrade.executioner(command, command, 0)
