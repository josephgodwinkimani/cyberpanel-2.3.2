...
def versionManagment(request):
    ...
    u = "https://api.github.com/repos/josephgodwinkimani/cyberpanel-2.3.2/commits?sha=v%s.%s" % (latestVersion, latestBuild)
...
def design(request):
    ...
    sha_url = "https://api.github.com/repos/josephgodwinkimani/cyberpanel-2.3.2-Themes/commits"

    sha_res = requests.get(sha_url)

    sha = sha_res.json()[0]['sha']

    l = "https://api.github.com/repos/josephgodwinkimani/cyberpanel-2.3.2-Themes/git/trees/%s" % sha
    fres = requests.get(l)
...
def getthemedata(request):
    try:
        ...
        url = "https://raw.githubusercontent.com/josephgodwinkimani/cyberpanel-2.3.2-Themes/main/%s/design.css" % data['Themename']
