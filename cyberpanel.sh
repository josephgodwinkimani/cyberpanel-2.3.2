...
#  exit
#fi
#remove per https://github.com/josephgodwinkimani/cyberpanel-2.3.2/issues/589
...
#wget -O /root/php_session_script.sh "${Git_Content_URL}/v2.3.2/CPScripts/setup_php_sessions.sh"
...
if [[ "$Watchdog" = "On" ]]; then
  wget -O /etc/cyberpanel/watchdog.sh "${Git_Content_URL}/v2.3.2/CPScripts/watchdog.sh"
