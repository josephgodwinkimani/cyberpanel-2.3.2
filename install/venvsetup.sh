...
sed -i 's|git clone https://github.com/josephgodwinkimani/cyberpanel-2.3.2|echo downloaded|g' install.py
...
#line1="$(grep -n "github.com/josephgodwinkimani/cyberpanel-2.3.2" install.py | head -n 1 | cut -d: -f1)"
#line2=$((line1 - 1))
...
sed -i 's|git clone https://github.com/josephgodwinkimani/cyberpanel-2.3.2|wget https://cyberpanel.sh/cyberpanel-git.tar.gz \&\& tar xzvf cyberpanel-git.tar.gz|g' install.py
...
wget -O requirements.txt https://raw.githubusercontent.com/josephgodwinkimani/cyberpanel-2.3.2/1.8.0/requirments.txt
...
if [[ $DEV == "ON" ]] ; then
	#install dev branch 
	#wget https://raw.githubusercontent.com/josephgodwinkimani/cyberpanel-2.3.2/$BRANCH_NAME/requirments.txt
	cd /usr/local/
	python3.6 -m venv CyberPanel
	source /usr/local/CyberPanel/bin/activate
	wget -O requirements.txt https://raw.githubusercontent.com/josephgodwinkimani/cyberpanel-2.3.2/$BRANCH_NAME/requirments.txt
...
if [[ $SERVER_COUNTRY == "CN" ]] ; then
	...
	if [[ $DEV == "ON" ]] ; then
	git clone https://github.com/josephgodwinkimani/cyberpanel-2.3.2
	cd cyberpanel
